<div class="nk-sidebar">
    <div class="nk-nav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li class="nav-label">Super Admin Dashboard</li>

            <li><a href="{{('/systemadmin/companies')}}" aria-expanded="false"><i class="icon-diamond"></i><span class="nav-text">Manage Companies</span></a></li>
            <li><a href="{{('/systemadmin/ranks')}}" aria-expanded="false"><i class="icon-puzzle"></i><span class="nav-text">Manage Ranks</span></a></li>
            <li><a href="{{('/systemadmin/requests')}}" aria-expanded="false"><i class="icon-badge"></i><span class="nav-text">Company Requests</span></a></li>


            @elseif(Auth::user()->hasRole(['CompanyAdmin']))

            <li class="nav-label">Compnay Admin</li>

            <li><a href="{{('/company/admin/statistics')}}" aria-expanded="false"><i class="icon-diamond"></i><span class="nav-text">Company Statistics</span></a></li>



            @elseif(Auth::user()->hasRole(['CompanyManager']))

            <li class="nav-label">Company Manager</li>
            ...
            <li class="nav-label">Company Accountant</li>
