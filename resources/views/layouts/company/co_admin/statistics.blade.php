...
@section('page_title') Statistics @endsection

@section('dashboard_links')
<link rel="stylesheet" href="{{url('company')}}/assets/plugins/owl.carousel/dist/css/owl.carousel.min.css">
<link href="{{url('company')}}/assets/plugins/fullcalendar/css/fullcalendar.min.css" rel="stylesheet">
<!-- Chartist -->
<link rel="stylesheet" href="{{url('company')}}/assets/plugins/chartist/css/chartist.min.css">
                    ...
                    <div class="col-sm-6 col-xxl-6 col-xl-6">
                        <div class="card">
                            <div class="card-body pb-0">
                                ...
                                <div>
                                    <span class="text-success"><i class="mdi mdi-arrow-up-bold"></i> 15.365% </span>
            ...
            <div class="col-12">
                <div class="top_menu_carousel owl-carousel" id="top_menu_carousel">
                    <div class="card vertical-card__menu">
                        <div class="card-header p-0">
                            <div class="vertical-card__menu--image">
                                <img src="{{url('company')}}/assets/images/menu/granny-menu10.jpg" alt="Menu">
                            </div>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card vertical-card__menu">
                        <div class="card-header p-0">
                            <div class="vertical-card__menu--image">
                                <img src="{{url('company')}}/assets/images/menu/granny-menu11.jpg" alt="Menu">
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="vertical-card__menu--desc">
                    ...
                    <div class="card vertical-card__menu">
                        <div class="card-header p-0">
                            <div class="vertical-card__menu--image">
                                <img src="{{url('company')}}/assets/images/menu/granny-menu12.jpg" alt="Menu">
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="vertical-card__menu--desc">
                    ...
                    <div class="card vertical-card__menu">
                        <div class="card-header p-0">
                            <div class="vertical-card__menu--image">
                                <img src="{{url('company')}}/assets/images/menu/granny-menu13.jpg" alt="Menu">
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="vertical-card__menu--desc">
                    ...
                    <div class="card vertical-card__menu">
                        <div class="card-header p-0">
                            <div class="vertical-card__menu--image">
                                <img src="{{url('company')}}/assets/images/menu/granny-menu14.jpg" alt="Menu">
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="vertical-card__menu--desc">
                    ...
                    <div class="card vertical-card__menu">
                        <div class="card-header p-0">
                            <div class="vertical-card__menu--image">
                                <img src="{{url('company')}}/assets/images/menu/granny-menu15.jpg" alt="Menu">
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="vertical-card__menu--desc">
                    ...
                    <div class="card vertical-card__menu">
                        <div class="card-header p-0">
                            <div class="vertical-card__menu--image">
                                <img src="{{url('company')}}/assets/images/menu/granny-menu16.jpg" alt="Menu">
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="vertical-card__menu--desc">
                    ...
                    <div class="card vertical-card__menu">
                        <div class="card-header p-0">
                            <div class="vertical-card__menu--image">
                                <img src="{{url('company')}}/assets/images/menu/granny-menu5.jpg" alt="Menu">
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="vertical-card__menu--desc">
                    ...
                    <div class="card vertical-card__menu">
                        <div class="card-header p-0">
                            <div class="vertical-card__menu--image">
                                <img src="{{url('company')}}/assets/images/menu/granny-menu6.jpg" alt="Menu">
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="vertical-card__menu--desc">
                            ...
                            <div class="tab-content tab-content-default">
                                ...
                                <div class="tab-pane fade" id="info1">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="media">
                                                <img src="{{url('company')}}/assets/images/avatar/1.jpg" width="35" alt="reviewer">
                                        ...
                                        <div class="col-md-12">
                                            <div class="media mt-4">
                                                <img src="{{url('company')}}/assets/images/avatar/2.jpg" width="35" alt="reviewer">
                                                <div class="media-body ml-4">
                                                    <div class="d-flex justify-content-between">
                                                        <strong>Antony Jonus</strong>
                                                        <div class="vertical-card__menu--rating c-pointer">
                ...
                <div class="card top_menu_widget">
                    <div class="card-body">
                        ...
                        <div class="media border-bottom pt-3 pb-3">
                            <img width="50" height="50"  alt="#" class="mr-3" src="{{url('company')}}/assets/images/menu/menu1.png">
                        ...
                        <div class="media border-bottom pt-3 pb-3">
                            <img width="50" height="50"  alt="#" class="mr-3" src="{{url('company')}}/assets/images/menu/menu2.png">
                            <div class="media-body">
                        ...
                        <div class="media border-bottom pt-3 pb-3">
                            <img width="50" height="50"  alt="#" class="mr-3" src="{{url('company')}}/assets/images/menu/menu3.png">
                            <div class="media-body">
                        ...
                        <div class="media border-bottom pt-3 pb-3">
                            <img width="50" height="50"  alt="#" class="mr-3" src="{{url('company')}}/assets/images/menu/menu4.png">
                            <div class="media-body">
                        ...
                        <div class="media border-bottom pt-3 pb-3">
                            <img width="50" height="50"  alt="#" class="mr-3" src="{{url('company')}}/assets/images/menu/menu5.png">
                            <div class="media-body">
                        ...
                        <div class="media pt-3 pb-3">
                            <img width="50" height="50"  alt="#" class="mr-3" src="{{url('company')}}/assets/images/menu/menu6.png">
                            <div class="media-body">
            ...
            <div class="col-lg-4 col-xxl-4">
                <div class="card performence_score">
                    <div class="card-body">
                        ...
                        <div id="activity">
                            <div class="media border-bottom pt-3 pb-3">
                                <img src="{{url('company')}}/assets/images/avatar/1.jpg" alt="avatar" class="mr-3">
                                <div class="media-body">
                            ...
                            <div class="media border-bottom pt-3 pb-3">
                                <img src="{{url('company')}}/assets/images/avatar/2.jpg" alt="avatar" class="mr-3">
                                <div class="media-body">
                            ...
                            <div class="media border-bottom pt-3 pb-3">
                                <img src="{{url('company')}}/assets/images/avatar/3.jpg" alt="avatar" class="mr-3">
                                <div class="media-body">
                            ...
                            <div class="media border-bottom pt-3 pb-3">
                                <img src="{{url('company')}}/assets/images/avatar/4.jpg" alt="avatar" class="mr-3">
                                <div class="media-body">
                            ...
                            <div class="media border-bottom pt-3 pb-3">
                                <img src="{{url('company')}}/assets/images/avatar/5.jpg" alt="avatar" class="mr-3">
                                <div class="media-body">
                            ...
                            <div class="media border-bottom pt-3 pb-3">
                                <img src="{{url('company')}}/assets/images/avatar/6.jpg" alt="avatar" class="mr-3">
                                <div class="media-body">
                            ...
                            <div class="media pt-3 pb-3">
                                <img src="{{url('company')}}/assets/images/avatar/7.jpg" alt="avatar" class="mr-3">
                                <div class="media-body">
...
<!-- Datamap -->
<script src="{{url('company')}}/assets/plugins/d3v3/index.js"></script>
<script src="{{url('company')}}/assets/plugins/topojson/topojson.min.js"></script>
<script src="{{url('company')}}/assets/plugins/datamaps/datamaps.world.min.js"></script>
<!-- Calender -->
<script src="{{url('company')}}/assets/plugins/jqueryui/js/jquery-ui.min.js"></script>
<script src="{{url('company')}}/assets/plugins/moment/moment.min.js"></script>
<script src="{{url('company')}}/assets/plugins/fullcalendar/js/fullcalendar.min.js"></script>
<!-- ChartJS -->
<script src="{{url('company')}}/assets/plugins/chart.js/Chart.bundle.min.js"></script>
<!-- MorrisJS -->
<script src="{{url('company')}}/assets/plugins/raphael/raphael.min.js"></script>
<script src="{{url('company')}}/assets/plugins/morris/morris.min.js"></script>
<!-- Owl carousel -->
<script src="{{url('company')}}/assets/plugins/owl.carousel/dist/js/owl.carousel.min.js"></script>
<!-- Chartist -->
<script src="{{url('company')}}/assets/plugins/chartist/js/chartist.min.js"></script>
<script src="{{url('company')}}/assets/plugins/chartist-plugin-tooltips/js/chartist-plugin-tooltip.min.js"></script>


<!-- Init files -->
<script src="{{url('company')}}/main/js/plugins-init/fullcalendar-init.js"></script>
<script src="{{url('company')}}/main/js/dashboard/dashboard-1.js"></script>
@endsection
